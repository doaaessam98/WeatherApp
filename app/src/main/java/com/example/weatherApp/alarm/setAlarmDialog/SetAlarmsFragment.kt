...
import com.example.weatherApp.alarm.AlarmReceiver
import com.example.weatherApp.alarm.AlarmRepetedWorkManger
...
class SetAlarmsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding= DataBindingUtil.inflate(inflater,R.layout.fragment_set_allarm
            ,container,false)
